...
describe('SendForgotPasswordEmail', () => {
  ...
  it('should be able to reset a password by email.', async () => {
  ...
  it('should not be able to recover a password for a non existent user email.', async () => {
    await expect(
  ...
  it('should be able to generate a valid password reset token.', async () => {
